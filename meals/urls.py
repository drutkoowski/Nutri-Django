...
urlpatterns = [
    ...
    path('/data/save/new-meal-element', views.add_new_meal_element, name='add-new-meal-element'),
    path('/data/get/saved-meal/macro-summary', views.get_eaten_macro_today, name='get-eaten-macro-today'),
